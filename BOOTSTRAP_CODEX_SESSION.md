...
This repository owns Raspberry Pi client implementation, ambient/touch UI runtime, Pi packaging source and localized rendering for Pi presentation surfaces.

This repository does not own canonical backend intelligence, Music DNA storage, Spotify credentials, canonical Profile resolution or foundation docs.
