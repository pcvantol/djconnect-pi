...
DJCONNECT_VERSION="${DJCONNECT_VERSION:-3.1.2}"
DJCONNECT_REPO="${DJCONNECT_REPO:-pcvantol/djconnect-pi}"
...
Environment:
  DJCONNECT_VERSION=3.1.2
  DJCONNECT_REPO=pcvantol/djconnect-pi
...
payload = {
    ...
    "paired": False,
    "version": "3.1.2",
    "update_repo": "pcvantol/djconnect-pi",
