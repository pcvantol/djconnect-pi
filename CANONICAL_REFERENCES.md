...
- Canonical repository: `pcvantol/djconnect-pi` for repository-specific technical
  design, implementation, build, release and test details.
- Local responsibility: maintain implementation reality for Raspberry Pi client implementation, ambient/touch UI runtime, Pi packaging source and localized rendering for Pi presentation surfaces.
